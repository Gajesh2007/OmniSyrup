...
contract SmartChef is NonblockingLzApp, ReentrancyGuard {
   ...
   using SafeERC20 for IERC20;
     ...
     * @param _decimalsRewardToken: number of decimals in the reward token
     */
    constructor(
        address _lzEndpoint,
        IERC20 _stakedToken,
        ...
        uint256 decimalsRewardToken = _decimalsRewardToken;
    ...
    /*
     * @notice Remotely deposit staked tokens and collect reward tokens (if any)
